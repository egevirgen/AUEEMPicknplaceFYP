...
while(1):
	...
	if uart(center_temp,center_memory,center_temp_x,center_temp_y) != None:
		print uart(center_temp,center_memory,center_temp_x,center_temp_y)
		ser.write(uart(center_temp,center_memory,center_temp_x,center_temp_y).encode('utf-8'))
